...
export const taskSchema = z.object({
  ...
  status: z.enum(['backlog', 'todo', 'in_progress', 'internal_review', 'client_review', 'blocked', 'completed', 'cancelled']),
  priority: z.enum(['low', 'medium', 'high', 'urgent']),
...
export const opportunitySchema = z.object({
  ...
  stage: z.enum(['new', 'to_qualify', 'contacted', 'call_scheduled', 'brief_received', 'estimate_todo', 'estimate_sent', 'negotiation', 'won', 'lost', 'paused']),
  priority: z.enum(['low', 'medium', 'high', 'urgent']),
  source: z.string().optional(),
});
